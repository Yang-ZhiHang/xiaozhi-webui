  ...
  <div class="phone-call-container" :class="{ visible: props.isVisible }">
    <div class="voice-avatar-container">
      <div
        ...
        :class="{
          speaking:
            props.chatStateManager.currentState.value === ChatState.AI_SPEAKING,
        }"
      >
    ...
    <div class="voice-wave-container">
      <div
        ...
        :class="{
          active:
            props.chatStateManager.currentState.value ===
            ChatState.USER_SPEAKING,
        }"
        :style="{
          '--wave-height': `${voiceAnimationManager.voiceWaveHeight.value}px`,
        }"
      >
